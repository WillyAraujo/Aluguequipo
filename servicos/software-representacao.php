...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software representação, programa gerenciar representação, programa atendimento revendas">
		<meta name="description" content="Procura um programa para gerenciar sua Revenda, controlar Vendas, Estoque e Financeiro, tudo em um só software? Nós temos a solução!">
		<title>Software para Representação</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Representação</h1>
							<p>Procura um programa para gerenciar sua Revenda, controlar Vendas, Estoque e Financeiro, tudo em um só software? Nós temos a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sgr.png" alt="software revenda representação"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Representação</h4>
							<p>
								...
								- Tela de Cadastro de Fornecedor/Representada<br>
								- Tela de Cadastro de Vendedor<br>
								- Tela de Cadastro e Pesquisa de Produto e Estoque<br>
								- Tela de Reposição de Estoque<br>
								- Tela de Vendas<br>
								- Tela para Configurar parâmetros de Venda<br>
								- Tela para Pesquisar Contas a Receber<br>
								- Tela para Pesquisar Contas a Pagar<br>
								- Tela para Gerenciar Movimento de Caixa<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sgr2.png" alt="sistema gerenciar representação">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sgr1.png" alt="programa revenda estoque">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Revenda na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
