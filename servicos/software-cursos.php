...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software cursos agendamento, software controle contratos, programa para gerenciar cursos, programa cursos financeiro">
		<meta name="description" content="Quer um programa pra gerenciar Cursos, com controle sobre agenda, contratos e financeiro tudo em um só software? Encontre aqui o que você precisa!">
		<title>Software para Cursos</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Cursos</h1>
							<p>Quer um programa pra gerenciar Cursos, com controle sobre agenda, contratos e financeiro tudo em um só software? Encontre aqui o que você precisa!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/scu.png" alt="software gerenciamento cursos"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<p>
								...
								- Tela de Cadastro de Contratos<br>
								- Tela de Cadastro de Turma<br>
								- Tela de Cadastro de Agendamentos<br>
								- Tela de Consulta de Alunos<br>
								- Tela de Agendamento por Aluno<br>
								- Tela de Agendamento por Professor<br>
								- Tela de Relatórios dos Contratos<br>
								- Tela de Relatórios dos Contratos por Alunos<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/scur1.png" alt="sistema contratos cursos">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, cadastro e contratos dos alunos, financeiro e movimento de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/scu.png" alt="programa cursos ensino">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre o Instituto na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo da sua Instituição de Ensino.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
