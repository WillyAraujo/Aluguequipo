...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para ordem de serviço, software para Mecânica, programa para ordem de serviço, sistema para vendas e financeiro">
		<meta name="description" content="Em busca de uma forma de administrar sua Oficina Mecânica e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Entre em contato, temos a solução!">
		<title>Software para Oficina Mecânica</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Oficina Mecânica</h1>
							<p>Em busca de uma forma de administrar sua Oficina Mecânica e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Entre em contato, temos a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/som.png" alt="software ordem de serviço" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Oficina Mecânica</h4>
							<p>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/som1.png" alt="sistema mecânica vendas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/som2.png" alt="programa ordem de serviços mecanica">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
