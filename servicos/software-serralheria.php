...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software serralheria vendas, programa serralheria estoque, programa vendas financeiro">
		<meta name="description" content="Precisa de um programa para gerenciar sua Serralheria, com controle de vendas, estoque e financeiro, tudo em um só software? Nós temos a solução!">
		<title>Software para Serralheria</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Serralheria</h1>
							<p>Precisa de um programa para gerenciar sua Serralheria, com controle de vendas, estoque e financeiro, tudo em um só software? Nós temos a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sser.png" alt="software serralheria vendas"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Serralheria</h4>
							<p>
								...
								- Tela de Cliente com Fotos<br>
								- Tela de Fornecedores<br>
								- Tela de Vendedores<br>
								- Tela de Atendentes<br>
								- Tela de Ordem de Serviço<br>			
								- Tela de Orçamento<br>
								- Tela de Venda Balcão<br>
								- Tela de Agendamento de Serviços<br>
								- Tela de Pedido de Compras<br>		
								- Tela de Cadastro de Produtos com até 2 fotos<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sser1.png" alt="sistema vendas serralheria">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sser2.png" alt="programa estoque serralheria">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Serralheria na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
