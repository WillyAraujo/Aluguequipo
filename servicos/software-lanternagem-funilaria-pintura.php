...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para funilaria, software pintura, programa para lanternagem, sistema estoque e financeiro">
		<meta name="description" content="Está procurando um sistema para administrar sua empresa, ter controle sobre os serviços prestados e do Financeiro tudo em um só software? Nós temos exatamente o que você busca!">
		<title>Software para Lanternagem, Funilaria e Pintura</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Lanternagem, Funilaria e Pintura</h1>
							<p>Está procurando um sistema para administrar sua empresa, ter controle sobre os serviços prestados e do Financeiro tudo em um só software? Nós temos exatamente o que você busca!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/slf.png" alt="software lanternagem funilaria" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Lanternagem, Funilaria e Pintura</h4>
							<p>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/slf1.png" alt="sistema financeiro pintura">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/slf2.png" alt="programa lanternagem pintura">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
