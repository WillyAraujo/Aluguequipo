...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software clube agendamento, software controle clube, programa para gerenciar clube, programa clube socios financeiro">
		<meta name="description" content="Você procura por um sistema pra gerenciar o Clube, com agenda e controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!">
		<title>Software para Gerenciar Clube</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Gerenciar Clube</h1>
							<p>Você procura por um sistema pra gerenciar o Clube, com agenda e controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/scl.png" alt="software gerenciamento clube"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Gerenciar Clube</h4>
							<p>
								...
								- Tela de Cadastro de Membros e Sócios<br>	
								- Tela de Cadastro de Fornecedores<br>
								- Tela de Cadastro de Funcionários<br>
								- Tela de Cadastro de Contribuições<br>
								- Tela de Cadastro de Modalidades<br>
								- Tela de Cadastro e Emissão de Carteirinhas<br>
								- Tela de Cadastro e Controle de Agendamentos<br>
								- Tela de Consulta de Cartas<br>
								- Tela de Controle de Numeração<br>
								- Tela de Relatórios dos Membros<br>
								- Tela de Relatórios das Modalidades<br>
								- Tela de Relatórios das Contribuições por Membros<br>
								- Tela de Movimento de Caixa<br>
								- Tela de Contas a Pagar e a Receber<br>
								- Tela de Relatório Financeiro<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/scl1.png" alt="sistema controle clube">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, cadastro e contribuição dos membros e sócios, financeiro e movimento de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/scl2.png" alt="programa agendamento clube">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre o Clube na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo do seu Clube.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
