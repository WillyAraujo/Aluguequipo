...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para ordem de serviço, software para OS Gerais, programa para ordem de serviço, sistema para vendas e financeiro">
		<meta name="description" content="Que tal administrar seu Negócio, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Aqui você encontra exatamente o que está procurando!">
		<title>Software para Ordem de Serviços Gerais</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Ordem de Serviços Gerais</h1>
							<p>Que tal administrar seu Negócio, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Aqui você encontra exatamente o que está procurando!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sosvf.png" alt="software ordem de serviço" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Ordem de Serviços Gerais</h4>
							<p>
								...
								Tela Cadastro Cliente com Foto<br>
								Tela Cadastro Fornecedores<br>
								Tela Cadastro de Vendedores e Atendentes<br>								
								Tela de Ordem de Serviço<br>
								Tela de Orçamento<br>
								Tela de Venda Balcão<br>
								Tela de Agendamentos de Serviços<br>
								Tela de Pedido de Compra<br>
								Tela de Cadastro Produtos com até duas Fotos<br>
								Tela de Controle do Estoque <br>
								Tela de Relação de Produtos<br>
								Tela de Relação de Produtos para Reposição<br>
								Tela de Reajuste de Preços em Bloco<br>
								Tela de Contas a Pagar e a Receber<br>								
								Tela de Controle Financeiro / Caixa<br>								
								Tela de Plano de Contas<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sosvf1.png" alt="sistema vendas e financeiro serviços gerais">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos serviços prestados, estoque e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sosvf2.png" alt="programa ordem de serviços gerais">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre agendamentos de serviços, controle do estoque e financeiro na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
