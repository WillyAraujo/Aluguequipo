...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para loja de pneus, software para loja de rodas, programa para vendas de rodas e pneus, sistema para vendas, estoque e financeiro">
		<meta name="description" content="Você procura um Programa para administrar sua Loja de Rodas e Pneus, e quer organizar as Vendas, e ter controle do Estoque e Financeiro tudo em um só software? Temos exatamente o que você procura!">
		<title>Software para Loja de Rodas e Pneus, Vendas, Estoque e Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Loja de Rodas e Pneus, Vendas, Estoque e Financeiro</h1>
							<p>Você procura um Programa para administrar sua Loja de Rodas e Pneus, e quer organizar as Vendas, e ter controle do Estoque e Financeiro tudo em um só software? Temos exatamente o que você procura!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/slrp.png" alt="software loja rodas" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Loja de Rodas e Pneus, Vendas, Estoque e Financeiro</h4>
							<p>
								...
								- Tela de Ficha Cadastral do Veículo<br>		
								- Tela de Relatório de Serviços por Veículo<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/slrp1.png" alt="sistema vendas pneus">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/slrp2.png" alt="programa estoque pneus">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre vendas, controle do estoque e financeiro na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
