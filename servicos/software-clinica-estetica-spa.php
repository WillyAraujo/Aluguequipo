...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software clinica estetica, programa spa com agendamento, programa agendamento vendas">
		<meta name="description" content="Quer um programa para ter controle dos agendamentos da sua Estética, Relatórios de Vendas e controle do Estoque tudo em um só software? Encontre aqui o que você precisa!">
		<title>Software para Clínica de Estética e SPA</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Clínica de Estética e SPA</h1>
							<p>Quer um programa para ter controle dos agendamentos da sua Estética, Relatórios de Vendas e controle do Estoque tudo em um só software? Encontre aqui o que você precisa!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sce.png" alt="software estetica spa"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Clínica de Estética e SPA</h4>
							<p>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sce1.png" alt="sistema spa agendamento">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sce2.png" alt="programa clinica estetica">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Clínica Estética na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
