...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para ordem de serviço, software para lavação, programa para lavação automotiva, sistema para vendas e financeiro">
		<meta name="description" content="Que tal administrar sua Lavação Automotiva e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Encontre aqui o que você precisa!">
		<title>Software para Lavação Automotiva</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Lavação Automotiva</h1>
							<p>Que tal administrar sua Lavação Automotiva e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Encontre aqui o que você precisa!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sla.png" alt="software lavação automotiva" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Lavação Automotiva</h4>
							<p>
								...
								Tela Cadastro de Placas<br>							
								Tela de Cadastro de Produtos e serviços<br>
								Tela de Controle de Estoque<br>
								Tela de Controle de Caixa<br>
								Tela de Contas a Pagar e a Receber<br>
								Tela de Ordem de Serviço<br>
								Tela de Pedido de Vendas no Balcão<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sla1.png" alt="sistema lavação vendas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sla2.png" alt="programa lavação automotiva">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre agendamentos, controle do estoque e financeiro na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
