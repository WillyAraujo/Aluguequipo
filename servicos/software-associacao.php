...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software associação agendamento, software controle associação, programa para gerenciar associação, programa associação socios financeiro">
		<meta name="description" content="Você procura por um sistema pra gerenciar a Associação, com agenda e controle financeiro tudo em um só software? Encontre aqui o que você precisa!">
		<title>Software para Gerenciar Associação</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Gerenciar Associação</h1>
							<p>Você procura por um sistema pra gerenciar a Associação, com agenda e controle financeiro tudo em um só software? Encontre aqui o que você precisa!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sga.png" alt="software gerenciamento associação"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Gerenciar Associação</h4>
							<p>
								...
								- Tela de Cadastro de Membros e Associados<br>	
								...
								- Tela de Relatórios dos Associados<br>
								- Tela de Relatórios das Contribuições por Associados<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sga1.png" alt="sistema controle associação">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sga2.png" alt="programa agendamento associação">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre a Associação na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo da sua Associação.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
