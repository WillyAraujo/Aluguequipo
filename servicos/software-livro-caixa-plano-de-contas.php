...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software livro caixa, software plano de contas, programa para conta corrente, sistema relatório financeiro">
		<meta name="description" content="Procura por um programa em que possa controlar o seu Livro Caixa e/ou Plano de Contas, ter acesso ao movimento e relatórios tudo em um só software? Aqui você encontra exatamente o que está procurando!">
		<title>Software para Livro Caixa e Plano de Contas</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Livro Caixa e Plano de Contas</h1>
							<p>Procura por um programa em que possa controlar o seu Livro Caixa e/ou Plano de Contas, ter acesso ao movimento e relatórios tudo em um só software? Aqui você encontra exatamente o que está procurando!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/slc.png" alt="software livro caixa" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Livro Caixa e Plano de Contas</h4>
							<p>
								...
								- Tela Cadastro de Conta Corrente<br>
								- Tela de Movimento de Caixa<br>
								- Tela de Entrada (receita) e Saída (despesa)<br>		
								- Tela de Relatório do Caixa<br>
								- Tela de Controle de Saldo<br>
								- Tela de Plano de Contas<br>
								- Tela de Centro de Custo<br>
								- Tela de Controle de Cheque Compensado<br><br>								
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/slc2.png" alt="sistema plano de contas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle das entradas e saída, relatórios e movimento de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/slc3.png" alt="programa livro caixa financeiro">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre seu Livro Caixa e/ou Plano de Contas na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
