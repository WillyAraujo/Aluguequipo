...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para graficas, software para grafica rapida, sistema para vendas e financeiro">
		<meta name="description" content="Quer administrar sua Gráfica, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro e, ainda, ter um Relatório de lucratividade, tudo em um só software? Encontre aqui a solução!">
		<title>Software para Gráfica</title>
		<!-- Bootstrap CSS -->
			...
			<div class="container">
				<div class="row flexbox-center">
					<div class="col-lg-2 col-md-3 col-6">
						<div class="logo">
							<a href="https://aluguequipo.com.br/"><img src="../assets/img/logo.png" alt="logo" /></a>
						</div>
					</div>
					<div class="col-lg-10 col-md-9 col-6">
					    ...
					    <div class="mainmenu">
                            <ul id="primary-menu">
                                <li><a class="nav-link active" href="https://aluguequipo.com.br/">Início</a></li>
                                <li><a class="nav-link" href="#descricao">Descrição</a></li>
                                <li><a class="nav-link" href="#contact">Fale conosco</a></li>
                                <li><a class="nav-link" href="https://whereby.com/aluguequipo" target="blank">Demonstração</a></li>
                                <li><a class="nav-link" href="https://whereby.com/aluguequipo" target="blank">Demonstração</a></li>
                                <li><a class="nav-link" id="contato" href="https://api.whatsapp.com/send?1=pt_BR&phone=5548984121662"><img src="../assets/img/whatslogo.png" width="30px" height="30px"><p id="ddd">(48)</p>98412-1662</a></li>
                            </ul>
					    </div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Gráfica</h1>
							<p>Quer administrar sua Gráfica, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro e, ainda, ter um Relatório de lucratividade, tudo em um só software? Encontre aqui a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sg.png" alt="software vendas graficas" />
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<p>
								...
								Tela Cadastro de Vendedores e Funcionários<br>
								Tela Cadastro de Produtos e Serviços<br>								
								Tela de Controle do Estoque <br>
								Tela de Ordem de Serviço<br>
								Tela de Pedidos de Vendas e Orçamento<br>
								Tela de Pedido de Compra<br>
								Tela de Contas a Pagar e a Receber<br>								
								Tela de Fluxo de Caixa<br>								
								Tela de Relatório dos Serviços Executados<br>												
								Tela de Relatório das Vendas por data e por cliente<br>
								Tela de Relatório das Compras por data e por fornecedor<br>								
								Tela de Relatório do Resultado Financeiro<br>
								Tela de Relatório da Lucratividade<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sg1.png" alt="sistema vendas e financeiro grafica">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle das vendas, estoque e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sg2.png" alt="programa grafica estoque">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre vendas de produtos e serviços, fluxo de caixa e relatório de lucratividade na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
