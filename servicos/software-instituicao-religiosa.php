...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software instituição religiosa, software controle instituição religiosa, programa para agendamento instituição, programa igrejas e financeiro">
		<meta name="description" content="Você procura por um sistema pra auxiliar na organização da sua Instituição, com agenda e controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!">
		<title>Software de Controle para Instituição Religiosa</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software de Controle para Instituição Religiosa</h1>
							<p>Você procura por um sistema pra auxiliar na organização da sua Instituição, com agenda e controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/scr.png" alt="software instituição religiosa"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software de Controle para Instituição Religiosa</h4>
							<p>
								...
								- Tela de Cadastro de Membros<br>
								- Tela de Cadastro de Instituições<br>
								- Tela de Cadastro de Visitantes<br>
								- Tela de Cadastro de Eventos<br>
								- Tela de Fotos dos Cadastrados<br>
								- Tela de Ficha Completa dos Membros<br>
								- Tela de Controle de Agendamentos<br>
								- Tela de Cadastro de Contribuições<br>
								- Tela de Relatórios das Contribuições<br>
								- Tela de Relatórios das Contribuições por Membros<br>
								- Tela de Relatórios Estatísticos das Contribuições<br>
								- Tela de Movimento de Caixa<br>
								- Tela de Contas a Pagar e a Receber<br>
								- Tela de Relatório Financeiro<br>
								- Tela de Recibo de Pagamento<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/scr1.png" alt="sistema controle instituição">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, cadastro e contribuição dos membros, financeiro e movimento de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/scr2.png" alt="programa agendamento instituição">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Instituição na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo da sua Instituição Religiosa.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
