...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software salao de beleza, software para salao de beleza, software para salao, locação de software para salação de beleza, software para salao de belelza para alugar, alugar softare de salão de beleza, sistema para alugar, sistema de salao de beleza para aluguar, sistema de salao de beleza.">
		<meta name="description" content="Já pensou em cadastrar clientes, realizar agendamentos, receber lembretes dos atendimenos, registrar atendimentos e ainda ter controle financeiro e de estoque, tudo em um só software? Nós temos essa solução!">
		<title>Software Salão de Beleza</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software Salão de Beleza</h1>
							<p>Alugue já esse software para seu salão de beleza e desfrute de muito mais facilidade, mais praticidade e com muito mais segurança.</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
					    		<img src="../assets/img/salao1.png" alt="programa para salao de beleza" />
					    	</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
					    <div class="video-popup">
							<a href="https://youtu.be/q-RPbm5mrUo" class="popup-youtube"><i class="icofont icofont-ui-play"></i></a>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software Salão de Beleza</h4>
							<p>
								...
								- Pode formatar o computador e reinstalar o programa sem restrição de chave<br>
								- Você mesmo personalizar o fundo de tela do programa<br>
								- Você mesmo configura a logomarca no programa<br>
								- Campo Padrão na tela de vendas editável, personalizado<br><br>

								<h4>PRINCIPAIS CADASTRO E FUNÇÕES:</h4>

								Cadastro Cliente<br>
								Cadastro de Fornecedor<br>
								Cadastro de Atendentes<br>
								Cadastro de Atendimentos<br>
								Cadastro de Agendamentos<br>
								Agendamentos por Clientes<br>
								Agendamentos por Atendente<br>
								Pedido de Vendas<br>
								Pedido de Compras<br>
								Orçamentos<br>
								Cadastro de Produtos<br>
								Reajuste de Preços dos Produtos<br>
								Cadastro de Serviços<br>
								Relatório dos Atendimentos<br>
								Relatório dos Atendimentos por Cliente<br>
								Relatório dos Atendimentos por Atendente<br>
								Relatório de Comissões por Atendente<br>
								Controle de Estoque<br>
								Acesso por nivel de usuario<br>
								Logomarca na impressão do Atendimento<br>
							</p>
							<a href="hhttps://www.fpqsystem.com.br/avaliacao/Instalar_SALAO2_DEMO.exe" class="appao-btn appao-btn2">Baixar demonstração</a>
						</div>
					</div><br><br>
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/salao2.png" alt="software para salao de beleza">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>Organização</h4>
										<p>Organize tudo o que você precisa em apenas um software</p>
									</div>
								...
								<li>
									<div class="feature-box-info">
										<h4>Cadastro</h4>
										<p>Faça um cadastro completo dos clientes e assim, tenha melhor controle de sua clientela.</p>
									</div>
									<div class="feature-box-icon">
								...
								<li>
									<div class="feature-box-info">
										<h4>Tranquilidade</h4>
										<p>Tranquilize-se deixando que o software cuida de todo pra vocês.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/salao3.png" alt="sistema para salao de beleza">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								...
								<li>
									...
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha maior controle de financeiro, de estoque e de clientes.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
