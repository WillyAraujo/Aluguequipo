...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para atendimento, software para agendamento, agendamento atendimento, sistema para financeiro">
		<meta name="description" content="Que tal administrar seu Negócio, criar uma agenda de Atendimentos e controlar o financeiro, tendo tudo em um só software? Entre em contato, temos exatamente o que você quer!">
		<title>Software para Agendamento e Atendimento</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Agendamento e Atendimento</h1>
							<p>Que tal administrar seu Negócio, criar uma agenda de Atendimentos e controlar o financeiro, tendo tudo em um só software? Entre em contato, temos exatamente o que você quer!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/ag.png" alt="software agendamento e atendimento" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Agendamento e Atendimento</h4>
							<p>
								...
								Tela de Foto dos clientes no atendimento<br>
								Tela de Cadastro de Agendamento por Data e Hora<br>
								Tela de Relatórios dos Agendamentos<br>
								Tela de Relatórios dos Agendamentos por Data<br>
								Tela de Relatórios dos Agendamentos por Cliente<br>
								Tela de Relatórios dos Agendamentos por Atendente<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/ag1.png" alt="sistema controle agenda">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha controle dos atendimentos, clientes e agenda num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/ag2.png" alt="programa atendimento financeiro">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse rapidamente todas as informações dos agendamentos e atendimentos na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
