...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para oticas, software para relojoarias, sistema para vendas e financeiro">
		<meta name="description" content="Que tal administrar sua Ótica, criar uma agenda de Atendimentos, Controlar seu Estoque e Financeiro e, ainda, ter um Relatório de lucratividade, tudo em um só software? Entre em contato, temos exatamente o que você quer!">
		<title>Software para Ótica e Relojoaria</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Ótica e Relojoaria</h1>
							<p>Que tal administrar sua Ótica, criar uma agenda de Atendimentos, Controlar seu Estoque e Financeiro e, ainda, ter um Relatório de lucratividade, tudo em um só software? Entre em contato, temos exatamente o que você quer!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sor.png" alt="software agendamento oticas" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Ótica e Relojoaria</h4>
							<p>
								...
								Tela Cadastro e Pesquisa de Produtos e Estoque<br>								
								Tela Cadastro de Agendamentos <br>
								Tela Pedidos de Vendas<br>
								Tela Pedidos de Compras<br>
								Tela Reposição do Estoque<br>
								Tela da Ordem de Serviço<br>								
								Tela de Atendimento<br>								
								Tela pra Configurar Parâmetros de Venda<br>
								Tela pra Pesquisar Contas a Pagar e a Receber<br>
								Tela pra Gerenciar o Movimento de Caixa<br>
								Tela de Relatório das Ordens de Serviço<br>
								Tela de Relatório das Vendas por data e por cliente<br>
								Tela de Relatório das Compras por data e por fornecedor<br>								
								Tela de Vendas e Compras com Código de barras<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sor1.png" alt="sistema vendas e financeiro oticas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos de consultas, estoque e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sor2.png" alt="programa oticas e relojoarias">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre Compras, Vendas, Estoque e Financeiro, na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
