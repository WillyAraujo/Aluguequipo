...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software igreja, software controle igreja, programa para agendamento igreja, programa igrejas e financeiro">
		<meta name="description" content="Procurando um software pra auxiliar na organização da sua Igreja, com agenda e controle financeiro tudo em um só software? Temos exatamente o que você precisa!">
		<title>Software de Controle para Igrejas</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software de Controle para Igrejas</h1>
							<p>Procurando um software pra auxiliar na organização da sua Igreja, com agenda e controle financeiro tudo em um só software? Temos exatamente o que você precisa!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sci.png" alt="software igreja financeiro"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software de Controle para Igrejas</h4>
							<p>
								...
								- Tela de Cadastro de Igrejas<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sci1.png" alt="sistema controle igreja">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sci2.png" alt="programa agendamento igreja">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Igreja na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo da sua Igreja.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
