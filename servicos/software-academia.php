...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software academia agendamento, programa academia contratos, programa agendamento vendas">
		<meta name="description" content="Precisa de um software pra sua Academia? Algo que vá além dos outros programas, com controle sobre os agendamentos e contratos num único lugar? Aqui você encontra exatamente o que está procurando!">
		<title>Software para Academia</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Academia</h1>
							<p>Precisa de um software pra sua Academia? Algo que vá além dos outros programas, com controle sobre os agendamentos e contratos num único lugar? Aqui você encontra exatamente o que está procurando!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sac.png" alt="software academia agendamentos"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<p>
								...
								- Tela de Agendamento por Alunos<br>
								- Tela de Agendamento por Professor<br>		
								- Tela de Relatório dos Contratos<br>
								- Tela de Relatório dos Contratos por Alunos<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sac3.png" alt="sistema academia contratos">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, contratos e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sac2.png" alt="programa vendas academia">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Academia na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
