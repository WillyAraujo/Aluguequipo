...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para clinicas, software para agendamento, sistema para clinicas">
		<meta name="description" content="Quer administrar sua Clínica, criar uma agenda de Atendimentos, Relatórios sobre agendamentos e Controle de Contas a receber, tudo em um só software? Encontre aqui a solução!">
		<title>Software para Clínicas e Consultórios Médicos</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Clínicas e Consultórios Médicos</h1>
							<p>Quer administrar sua Clínica, criar uma agenda de Atendimentos, Relatórios sobre agendamentos e Controle de Contas a receber, tudo em um só software? Encontre aqui a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/am.png" alt="software agendamento clinica medica" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Clínicas e Consultórios Médicos</h4>
							<p>
								...
								Tela Cadastro Paciente<br>
								Tela Cadastro de Médicos<br>
								Tela Cadastro de Atendentes<br>
								Tela Cadastro de Convênios<br>
								Tela Cadastro de Atendimentos <br>
								Tela Cadastro de Agendamentos <br>
								Tela da Ficha Completa dos Pacientes<br>
								Tela de Foto dos pacientes<br>
								Tela de Relatórios dos Agendamentos<br>
								Tela de Relatórios dos Atendimentos<br>
								Tela de Relatórios dos Atendimentos por Paciente<br>
								Tela de Relatórios dos Atendimentos por Médico<br>
								Tela de Relatórios dos Atendimentos por Convênios<br>
								Tela de Contas a Receber<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/am1.png" alt="sistema agenda consultas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos de consultas, pacientes e exames num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/am2.png" alt="programa clinicas e consultorios">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse rapidamente todas as informações dos agendamentos e consultas na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
