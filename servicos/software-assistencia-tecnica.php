...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para assistência técnica, software para orçamento, software para controle financeiro, sistema para vendas, sistema para financeiro, sistema para assistência técnica">
		<meta name="description" content="Quer administrar seus atendimentos, orçamentos de produtos e serviços, controlar o financeiro, tudo em um só software? Temos exatamente o que você procura!">
		<title>Software para Assistência Técnica</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Assistência Técnica</h1>
							<p>Quer administrar seus atendimentos, orçamentos de produtos e serviços, controlar o financeiro, tudo em um só software? Temos exatamente o que você procura!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sat.png" alt="software assistência técnica" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Assistência Técnica</h4>
							<p>
								...
								- Assistência técnica em geral<br>
								- Empresas de Informática<br>
								- Empresas de remanufaturado de cartuchos<br>
								- Empresas de celulares<br>
								- Eletronicas<br>
								- Autorizadas<br>
								- Manutenção de equipamentos<br><br>

								<h4>Principais Telas:</h4><br>
								Tela Cadastro Cliente<br>
								Tela Cadastro Fornecedor<br>
								Tela Cadastro de Técnico<br>
								Tela Cadastro de Equipamentos<br>
								Tela Orçamento<br>
								Tela Ordem de Serviço<br>
								Tela Ordem de Serviço por cliente<br>						
								Tela de Contas a Receber<br>
								Tela de Produtos e Serviços <br>
								Tela de Controle de Estoque<br>
								Tela da Situação da OS<br>								
								Tela pra Rastrear Serviço por Nº de Série<br>								
							</p>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sat1.png" alt="sistema controle ordem de serviço">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha controle dos equipamentos, orçamentos e ordem de serviço num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sat2.png" alt="programa orçamentos e serviços">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse rapidamente todas as informações de cadastro dos seus clientes e situação atual de cada Ordem de Serviço.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize no estilo da sua empresa.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
