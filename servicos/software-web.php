...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="software web, software de ponto web, sisema de ponto web, sistema de ponto em nuvem, ponto home office, ponto web, sistema de ponto web, gerenciamento de ponto online, app de ponto, app de registro de ponto, registrador de ponto online, registrar ponto pelo celular, aplicativo de ponto pelo celular, aplicativo de ponto,">
		<meta name="description" content="Gerenciar os pontos a partir de de qualquer computador em qualquer lugar é bem mais confortável, não é mesmo? Isso sem falar na tranquilidade de saber que todos os seus dados estarão armazenamos em nuvem, sem risco de perda em caso de danos ao computador. Conheça os software de ponto web">
		<title>Software de Ponto WEB</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software de Ponto WEB<br>Em nuvem</h1>
							<p>Gerenciar os pontos a partir de de qualquer computador em qualquer lugar é bem mais confortável, não é mesmo? Isso sem falar na tranquilidade de saber que todos os seus dados estarão armazenamos em nuvem, sem risco de perda em caso de danos ao computador. Conheça os software de ponto web.</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
							<img src="../assets/img/web1.png" alt="software de ponto web" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
					    <div class="video-popup">
							<a href="https://www.youtube.com/watch?v=2JKUGWeicCQ" class="popup-youtube"><i class="icofont icofont-ui-play"></i></a>
		...
		<section class="showcase-area ptb-90" id="descricao">
			<div class="container">
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="../assets/img/web2.png" alt="sistema de ponto">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<img src="../assets/img/web3.png" alt="programa de ponto web">
						</div>
					</div>
					<div class="col-lg-4">
