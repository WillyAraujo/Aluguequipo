...
<html lang="pt-br">
	<head>
		...
		<meta name="description" content="Você procura um sistema para administrar sua empresa, ter controle sobre os serviços prestados e do Financeiro tudo em um só software? Encontre aqui a solução!">
		<title>Software para Bicicletaria com Serviços, Vendas, Estoque e Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Bicicletaria com Serviços, Vendas, Estoque e Financeiro</h1>
							<p>Você procura um sistema para administrar sua empresa, ter controle sobre os serviços prestados e do Financeiro tudo em um só software? Encontre aqui a solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sb.png" alt="software bicicletaria financeiro" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Bicicletaria com Serviços, Vendas, Estoque e Financeiro</h4>
							<p>
								...
								- Tela Cadastro de Cliente<br>
								- Tela Cadastro de Fornecedores<br>
								- Tela Cadastro de Atendentes e Vendedores<br>
								- Tela Cadastro de Bicicletas por Registro com até duas fotos<br>
								- Tela de Ficha Cadastral da Bicicleta<br>		
								- Tela de Relatório de Serviços por Registro<br>
								- Tela de Ordem de Serviço<br>
								- Tela de Rastrear Serviços por Bicicleta<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sb1.png" alt="sistema financeiro bicicleta">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sb2.png" alt="programa bicicletaria serviços">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
