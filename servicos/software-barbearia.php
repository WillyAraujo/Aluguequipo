...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software barbershop, programa barbearia agendamento, programa agendamento vendas">
		<meta name="description" content="Em busca de um sistema pra gerenciar sua BarberShop, Acompanhamento da Agenda, Relatório de Atendimentos e controle de Estoque, tudo em um só software? Nós temos exatamente o que você busca!">
		<title>Software para Barbearia, Agendamento e Vendas</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para BarberShop, Agendamento e Vendas</h1>
							<p>Em busca de um sistema pra gerenciar sua BarberShop, Acompanhamento da Agenda, Relatório de Atendimentos e controle de Estoque, tudo em um só software? Nós temos exatamente o que você busca!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/sbar.png" alt="software barbearia atendimento"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para BarberShop, Agendamento e Vendas</h4>
							<p>
								...
								- Tela de Cadastro de Atendente<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sbar1.png" alt="sistema barbershop vendas">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, vendas e estoque num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sbar2.png" alt="programa barbershop atendimento">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua BarberShop na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
