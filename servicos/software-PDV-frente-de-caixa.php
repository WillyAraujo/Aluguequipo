...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software PDV frente de caixa, software frente de caixa, programa para PDV, sistema estoque e financeiro">
		<meta name="description" content="Precisa de um sistema de Frente de Caixa para seu Ponto de Venda, com controle do estoque e financeiro tudo em um só software? Encontre aqui o que você procura!">
		<title>Software para PDV Frente de Caixa, Estoque e Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para PDV Frente de Caixa, Estoque e Financeiro</h1>
							<p>Precisa de um sistema de Frente de Caixa para seu Ponto de Venda, com controle do estoque e financeiro tudo em um só software? Encontre aqui o que você procura!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/spdv.png" alt="software PDV caixa" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para PDV Frente de Caixa, Estoque e Financeiro</h4>
							<p>
								...
								- Tela de Cadastro de Vendedor<br>
								- Tela de Cadastro e Pesquisa de Produtos e Estoque<br>
								- Tela de Reposição de Estoque<br>
								- Tela de Vendas, Contas a Pagar e a Receber<br>
								- Tela de Relatório dos Produtos Mais e Menos Vendidos<br>
								- Tela de Relatório dos Vendedores que Mais e Menos Vendem<br>
								- Tela para configurar parâmetros de Venda<br>
								- Tela para Gerenciar o Movimento de Caixa<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/spdv1.png" alt="sistema frente caixa">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle das vendas, estoque e financeiro, relatórios e movimento de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/spdv2.png" alt="programa caixa financeiro">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre o PDV na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
