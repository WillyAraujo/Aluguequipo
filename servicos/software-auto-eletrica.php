...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software salao de beleza, software para salao de beleza, software para salao, locação de software para auto eletrica, software para auto aletrica para alugar, alugar software de auto eletrica, sistema para alugar, sistema de auto aletrica para alugar, sistema de auto eletrica.">
		<meta name="description" content="Procurando um software para sua auto elétrica? Conheça esse software que organiza tudo em um só lugar e ainda te ajuda a organizar as finanças, vendas e gerar ordens de serviço.">
		<title>Software Auto Elétrica</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software Auto Elétrica</h1>
							<p>Procurando um software para sua auto elétrica? Conheça esse software que organiza tudo em um só lugar e ainda te ajuda a organizar as finanças, vendas e gerar orgens de serviço.</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
					    		<img src="../assets/img/sae.png" alt="programa auto eletrica" />
					    	</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<p>
								...
								- Ficha Cadastral do Veiculo;<br>
								- Relatório de Serviços por Veiculo;<br>
								- Ordem de Serviço;<br>
								- Rastrear serviços por placa;<br>
								- Pedido de Vendas no Balcão;<br>
								- Controle de Estoque;<br>
								- Contas a Receber;<br>
								- Contas a Pagar;<br>
								- Movimento de Caixa;<br>
								- Relatório dos Aniversariantes;<br>
								- Relatório dos Serviços Efetuados;<br>
								- Relatório das OS de Qualquer Período;<br>
								- Cadastro de Produtos & Serviços ( mão de obra );<br>
								- Configurar até 2 fotos por produto;<br>
								- Configurar logotipo;<br>
								- Configurar Fundo de Tela;<br>
								- Controle de Acesso por Nivel de Usuario;<br>
							</p>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/sae1.png" alt="software auto eletrica">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/sae2.png" alt="sistema auto eletrica">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
