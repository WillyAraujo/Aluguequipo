...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software clinica veterinária, programa agendamento veterinária, programa agendamento vendas">
		<meta name="description" content="Procura um programa em que possa ter controle dos agendamentos da sua Clínica Veterinária, Relatórios de Vendas e controle do Estoque tudo em um só software? Nós temos exatamente o que você busca!">
		<title>Software para Clínica Veterinária</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Clínica Veterinária</h1>
							<p>Procura um programa em que possa ter controle dos agendamentos da sua Clínica Veterinária, Relatórios de Vendas e controle do Estoque tudo em um só software? Nós temos exatamente o que você busca!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/scv.png" alt="software clinica veterinária"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Clínica Veterinária</h4>
							<p>
								...
								- Tela de Cadastro de Fornecedor<br>
								- Tela de Cadastro de Atendentes<br>
								- Tela de Cadastro de Veterinários<br>
								- Tela de Cadastro de Animais<br>
								- Tela de Cadastro de Atendimentos<br>
								- Tela de Cadastro de Agendamentos<br>
								- Tela de Agendamentos por Cliente<br>
								- Tela de Agendamentos por Atendente<br>
								- Tela de Pedido de Vendas<br>
								- Tela de Pedido de Compras<br>
								- Tela de Orçamentos<br>
								- Tela de Cadastro de Produtos<br>
								- Tela de Cadastro de Serviços<br>
								- Tela de Controle de Estoque<br>
								- Tela de Reajuste de Preços dos Produtos<br>
								- Tela de Relatório dos Atendimentos<br>
								- Tela de Relatório dos Atendimentos por Cliente<br>
								- Tela de Relatório dos Atendimentos por Atendente<br>
								- Tela de Relatório de Comissões por Atendente<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/scv1.png" alt="sistema veterinária agendamento">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos agendamentos, vendas, estoque e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/scv2.png" alt="programa clinica veterinária">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua Clínica Veterinária na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										...
										<p>Personalize de acordo com o estilo da sua empresa.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
