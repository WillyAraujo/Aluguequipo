	...
	<div class="container">
		<div class="row flexbox-center">
			...
			<div class="col-lg-10 col-md-9 col-6">
			    ...
			    <div class="mainmenu">
                    <ul id="primary-menu">
                        <li><a class="nav-link active" href="../index.php">Início</a></li>
                        <li><a class="nav-link" href="../equipamentos.php">Equipamentos</a></li>
                        ...
                        <li><a class="nav-link" id="contato" href="https://api.whatsapp.com/send?phone=5547999526056&text=Ol%C3%A1!%20Estou%20no%20site%20Aluguequipo%20e%20gostaria%20de%20saber%20mais."><img src="../assets/img/whatslogo.png" width="30px" height="30px"><p id="ddd">(47)</p>99952-6056</a></li>
                    </ul>
			    </div>
			</div>
		</div>
