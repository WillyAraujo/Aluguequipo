...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para loja de autosom, software para loja tuning, programa para vendas tuning, sistema para vendas de autosom, estoque e financeiro">
		<meta name="description" content="Precisa de um sistema para administrar sua Loja de Som Automotivo, organizar as Vendas e ter controle do Financeiro tudo em um só software? Encontre aqui a solução que você tanto procura!">
		<title>Software para Autosom e Tuning Vendas e Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Autosom e Tuning Vendas e Financeiro</h1>
							<p>Precisa de um sistema para administrar sua Loja de Som Automotivo, organizar as Vendas e ter controle do Financeiro tudo em um só software? Encontre aqui a solução que você tanto procura!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/satvf.png" alt="software loja som" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Autosom e Tuning Vendas e Financeiro</h4>
							<p>
								...
								- Tela de Rastrear Serviços por Placa<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/satvf1.png" alt="sistema financeiro autosom">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle das vendas e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/satvf2.png" alt="programa tuning vendas">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre vendas e financeiro na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
