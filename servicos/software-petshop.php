...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para Petshop, software para controle financeiro, agendamento Petshop, sistema para financeiro, sistema para Agropecuária">
		<meta name="description" content="Está procurando um sistema para administrar  sua Petshop, criar uma agenda de Atendimentos e controlar o financeiro, tudo em um só software? Nós temos exatamente o que você busca!">
		<title>Software para Petshop</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Petshop</h1>
							<p>Está procurando um sistema para administrar  sua Petshop, criar uma agenda de Atendimentos e controlar o financeiro, tudo em um só software? Nós temos exatamente o que você busca!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/ps.png" alt="software vendas financeiro" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
					    <div class="video-popup">
							<a href="https://www.youtube.com/watch?v=pqB3HK4gi4A" class="popup-youtube"><i class="icofont icofont-ui-play"></i></a>
			...
			<div class="container">
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							...
							<p>
								...
								Tela Cadastro de Atendentes<br>
								Tela Cadastro de Veterinários<br>
								Tela Cadastro de Animais<br>
								Tela Cadastro de Atendimentos<br>
								Tela Cadastro de Agendamentos<br>								
								Tela de Agendamento por Cliente<br>
								Tela de Agendamento por Atendente<br>
								...
								Tela de Relatório de Comissões por Atendente<br>								
								Tela de Controle de Estoque<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/ps1.png" alt="sistema controle estoque">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha controle dos agendamentos e atendimentos, clientes, vendas e comissões num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/ps2.png" alt="programa vendas e financeiro">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse rapidamente todas as informações de cadastro dos seus produtos, clientes e agendamentos na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
