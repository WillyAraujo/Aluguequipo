...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software espaço gourmet, programa espaço gourmet, programa vendas e financeiro">
		<meta name="description" content="Quer um sistema para auxiliar na administração do seu Espaço Gourmet, com controle de vendas, estoque e financeiro tudo em um só software? Aqui você encontra exatamente o que está procurando!">
		<title>Software para Espaço Gourmet</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Espaço Gourmet</h1>
							<p>Quer um sistema para auxiliar na administração do seu Espaço Gourmet, com controle de vendas, estoque e financeiro tudo em um só software? Aqui você encontra exatamente o que está procurando!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/seg.png" alt="software PDV financeiro"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Espaço Gourmet</h4>
							<p>
								...
								- Tela de Reposição do Estoque<br>
								- Tela de Vendas<br>
								- Tela para Configurar os Parâmetros da Venda<br>
								- Tela para Pesquisar Contas a Pagar e a Receber<br>
								- Tela para Gerenciar Movimento de Caixa<br>- Tela de Relatório dos Produtos mais e menos vendidos<br>
								- Tela de Relatório dos Vendedores que mais Venderam<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/seg1.png" alt="sistema vendas estoque">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle da venda, estoque e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/seg2.png" alt="programa espaco gourmet">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre seu Espaço Gourmet na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
