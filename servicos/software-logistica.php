...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software logistica, software entrega coleta, programa para logistica, programa logistica e financeiro">
		<meta name="description" content="Você procura por um sistema pra organizar a sua empresa de Logística, com relatórios das coletas e entregas e um controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!">
		<title>Software para Logística com Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Logística com Financeiro</h1>
							<p>Você procura por um sistema pra organizar a sua empresa de Logística, com relatórios das coletas e entregas e um controle financeiro tudo em um só software? Entre em contato, temos exatamente o que você quer!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/slog2.png" alt="software logistica financeiro"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Logística com Financeiro</h4>
							<p>
								...
								- Tela de Cadastro de Motorista<br>
								- Tela de Cadastro de Placa<br>
								- Tela de Ordem de Coleta<br>
								- Tela de Ordem de Entrega<br>
								- Tela de Relatório das Coletas e Entregas<br>
								- Tela de Relatório por tipo de Coleta e Entrega<br>
								- Tela de Controle Financeiro<br>
								- Tela de Contas a Pagar e a Receber<br>
								- Tela de Plano de Contas<br>
								- Tela de Fluxo de Caixa<br><br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/slog1.png" alt="sistema entrega coleta">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle das coletas e entregas, financeiro, relatórios e fluxo de caixa num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/slog.png" alt="programa logistica financeiro">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre sua empresa de logística na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
