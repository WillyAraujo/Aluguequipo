...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para ordem de serviço, software para Marcenaria, programa para ordem de serviço, sistema para vendas e financeiro">
		<meta name="description" content="Já pensou em administrar sua Marcenaria e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Nós temos essa solução!">
		<title>Software para Marcenaria com Ordem de Serviço</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Marcenaria com Ordem de Serviço</h1>
							<p>Já pensou em administrar sua Marcenaria e, através do Cadastro de Produtos e Serviços, Controlar seu Estoque e Financeiro, tudo em um só software? Nós temos essa solução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/smc.png" alt="software ordem de serviço" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Marcenaria com Ordem de Serviço</h4>
							<p>
								...
								Tela Controle de Estoque<br>
								Tela de Ordem de Serviço<br>
								Tela de Impressão da OS<br>
								Tela de Pedido de Vendas e Orçamento<br>
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/smc1.png" alt="sistema marcenaria e carpintaria">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/smc2.png" alt="programa ordem de serviços marcenaria">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
