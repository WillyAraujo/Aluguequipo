...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="aluguel de software, software para locação, software para bicicletaria, software bicicleta, programa para vendas bicicleta, sistema estoque e financeiro">
		<meta name="description" content="Está procurando um sistema para administrar sua Oficina de Moto, com checklist dos serviços prestados, Vendas, Estoque e Financeiro tudo em um só software? Encontre aqui a solução que você tanto procura!">
		<title>Software para Oficina Mecânica de Moto, Vendas, Estoque e Financeiro</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Software para Oficina Mecânica de Moto, Vendas, Estoque e Financeiro</h1>
							<p>Está procurando um sistema para administrar sua Oficina de Moto, com checklist dos serviços prestados, Vendas, Estoque e Financeiro tudo em um só software? Encontre aqui a solução que você tanto procura!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
					    	<div class="software">
								<img src="../assets/img/smm.png" alt="software mecânica moto" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Software para Oficina Mecânica de Moto, Vendas, Estoque e Financeiro</h4>
							<p>
								...
								- Tela Cadastro de Clientes com Foto<br>
								- Tela Cadastro de Fornecedores<br>
								- Tela Cadastro de Mecânicos<br>
								- Tela Cadastro de Veículos com Foto<br>
								- Tela Cadastro de Produtos e Serviços<br>
								- Tela de Ordem de Serviço<br>
								- Tela de Agendamento de Serviço<br>
								- Tela de Pedidos de Vendas no Balcão<br>
								- Tela de Controle de Estoque<br>
								- Tela de Contas a Pagar e a Receber<br>
								- Tela de Movimento de Caixa<br>
								- Tela de Reajuste de Preços em Bloco<br>	
								- Tela de Relatório dos Serviços Efetuados<br>
								- Tela de Relatório das OS de qualquer período<br><br>			
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<div class="software">
								<img src="../assets/img/smm1.png" alt="sistema oficina motocicleta">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row flexbox-center">
						...
						<div class="single-feature-box text-lg-right text-center">
							<ul>
								...
								<li>
									<div class="feature-box-info">
										<h4>Controle</h4>
										<p>Tenha total controle dos atendimentos e financeiro num só lugar.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<div class="software2">
								<img src="../assets/img/smm2.png" alt="programa moto serviços">
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Agilidade</h4>
										<p>Acesse todas as informações sobre serviços prestados e financeiro na hora em que quiser.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
