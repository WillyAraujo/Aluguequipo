...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="locação de central de alarme, central de alarme locação, aluguel, aluguel central de alarme, central de alarme para alugar, central de alarme com aplicativo, central de alarme com app, central de alarme com app para alugar">
		<meta name="description" content="Aluguel de central de alarme com aplicativo | Aluguequipo - Locação de equipamentos eletrônicos. Soluções para seu estabelecimento.">
		<title>Central de Alarme - Locação</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>Central de Alarme + App</h1>
							<p>DOs sistemas de alarme atendem as mais diversas necessidades. Sua tecnologia de ponta, permite repartir zonas com precisão, monitorar aberturas e automatizar ambientes ou sistemas de segurança com um custo-benefício atrativo.</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
							<img src="../assets/img/alarme.png" alt="central de alarme" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Central de Alarme + App</h4>
							<p>Soluções práticas, seguras e adequadas para todas as necessidades: de soluções econômicas, com as centrais não monitoradas, até integrações com empresas de segurança eletrônica e acompanhamento em tempo real via aplicativo, com as centrais monitoradas via IP.<br><br>

							Possui teclado LCD, comunicação de dados via tecnologia Ethernet, opção de configuração remota via TCP/IP, supervisão do link Ethernet com intervalos de tempo configuráveis, reportagem de eventos para 2 destinos IP (empresas de monitoramento), operação com IP fixo ou dinâmico e eliminação de custos com comunicação de dados, pois utiliza a infraestrutura de rede internet do próprio cliente.</p>
							<a href="https://backend.intelbras.com/sites/default/files/2020-02/Manual_AMT_4010_Smart_SmartNet%20%282%29.pdf" class="appao-btn appao-btn2">Ler datasheet</a>
						</div>
					</div><br><br>
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="../assets/img/central2.png" alt="central de alarme com app">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>Ideal pra Você</h4>
										<p> Ideal para empresas, residências, condomínios empresariais e demais estabelecimentos comerciais de pequeno e médio porte.</p>
									</div>
								...
								<li>
									<div class="feature-box-info">
										<h4>Praticidade</h4>
										<p>Possibilidade de conexão através do software para smartphone AMT MOBILE</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<img src="../assets/img/central1.png" alt="central de alarme com aplicativo">
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Eventos</h4>
										<p>Reportagem de eventos para 2 destinos IP (empresas de monitoramento).</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										<h4>Software</h4>
										<p>Software para download e upload (plataforma Windows®), compatível com a maioria dos modems convencionais.	</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
