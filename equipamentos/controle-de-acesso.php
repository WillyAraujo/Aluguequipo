...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="controle de acesso, controlador de acesso, aluguel, locação, aluguel de controle de acesso, locação de controlador de acesso, controlador de acesso para locação, controle de acesso para alugar.">
		<title>Controle de Acesso - Locação</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							...
							<p>De operação simples e intuitiva, o controlador de acesso permite autorizações por senha pessoal, cartão magnético, código de barras e biometria.</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
							<img src="../assets/img/controleAcesso.png" alt="controle de acesso" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>Controlador de Acesso</h4>
							<p>Com design compacto e moderno, o Controlador de Acesso iDAccess é capaz de monitorar com praticidade e segurança a entrada e saída de pessoas de um determinado recinto. Com capacidade para o armazenamento de até 200 mil registros e 100 mil diferentes impressões digitais (com o software iDSecure Enterprise), o iDAccess pode ser programado para restrições personalizadas por grupos e horários.<br><br>

							De operação simples e intuitiva, o Controlador de Acesso iDAccess permite autorizações por senha pessoal, cartão magnético, código de barras e biometria. Seu software embarcado dispensa instalações e possibilita a sincronização automática de backup em nuvem.</p>
							<a href="https://www.controlid.com.br/manual/idaccess.pdf" class="appao-btn appao-btn2">Ler datasheet</a>
						</div>
					</div><br><br>
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="../assets/img/controleAcesso2.jpg" alt="controlador de acesso">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>Software</h4>
										<p>Software de acesso web embarcado dispensando processos de instalação.</p>
									</div>
								...
								<li>
									<div class="feature-box-info">
										<h4>Acesso</h4>
										<p>Regras de acesso personalizadas por grupos e horários.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<img src="../assets/img/controleAcesso1.png" alt="controle de acesso">
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Identificação</h4>
										<p>Identificação biométrica, cartão de proximidade e senha.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										<h4>Alarme</h4>
										<p>Central de alarme integrada.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
