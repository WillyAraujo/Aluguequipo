...
<html lang="pt-br">
	<head>
		...
		<meta name="keywords" content="circuito fechado de tv, cftv, cftv com app, cftv com aplicativo, locação, aluguel, locação de cftv, cftv para aluguar, cftv para locação">
		<meta name="description" content="Aluguel de Circuito Fechado de TV (CFTV) | Aluguequipo - Locação de equipamentos eletrônicos. Soluções para seu estabelecimento.">
		<title>CFTV + App - Locação</title>
		<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="hero-area-content">
							<h1>CFTV + App</h1>
							<p>Com o Kit Câmeras de Segurança e CFTV você consegue identificar facilmente objetos e pessoas no momento em que mais precisar. Tenha imagens incríveis com qualidade e resolução!</p>
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
							<img src="../assets/img/cftv.png" alt="Hand Mockup" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<h4>CFTV + App</h4>
							<p>A câmera de segurança envia o sinal de vídeo ou imagens capturada a placa de captura ou DVR Stand Alone recebe a imagem e armazena ou grava com queira.<br><br>

							Para a câmera funcionar em perfeita harmonia com a placa de captura ou DVR Stand Alone tem que ser instalado Balum para casa a impedância entre os equipamentos, dessa forma a câmera também fica sem interferência no sinal de vídeo.<br><br>

							Para o bom funcionamento de uma câmera de segurança temos que instalar uma fonte de alimentação de boa qualidade e dimensionamento adequado para a câmera e qualidade no conector e cabo de vídeo para não ter perda no sinal.<br><br>

							Para o bom funcionamento de um gravador digital DVR Stand Alone, fonte de alimentação no break e ambiente adequado para o equipamento.
							<a href="#" class="appao-btn appao-btn2">Ler datasheet</a>
						</div>
					</div><br><br>
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="../assets/img/cftv4.png" alt="showcase">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row flexbox-center">
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>Monitoramento</h4>
										<p>Monitorar o ambiente 24 horas por dia, garantindo maior segurança.</p>
									</div>
								...
								<li>
									<div class="feature-box-info">
										<h4>Flexibilidade</h4>
										<p>imagens captadas pelo CFTV podem ser consultadas tanto em tempo real como posteriormente.</p>
									</div>
									<div class="feature-box-icon">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<img src="../assets/img/cftv.png" alt="feature">
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-feature-box text-lg-left text-center">
							<ul>
								<li>
									...
									<div class="feature-box-info">
										<h4>Tempo real</h4>
										<p>É possível utilizar smartphones, tablets e computadores conectados à internet para conferir tudo o que está acontecendo no local.</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
									...
									<div class="feature-box-info">
										<h4>Software</h4>
										<p>Sistemas Inteligentes de Análise de Imagem (contagem de pessoas, reconhecimento de placa de veículos, abandono de objetos, etc)</p>
									</div>
								</li>
								<li>
									<div class="feature-box-icon">
